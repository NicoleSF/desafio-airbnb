...
const DateCheckout =  styled.input`
  padding: 2px 25px;
  
`;

const TituloCheckout =  styled.h2`
  display: flex;
  color: #d32f2f;
  font-family: inherit;
    ...
    return (
      <BoxInicial>
        ...
        <Label>
          ...
          <DivCheck>
            <TituloCheck>Check-in:</TituloCheck>
            <DateCheck type="date"
          ...
          <DivCheckout>
            <TituloCheckout>Checkout:</TituloCheckout>
